            ...
            <div class="col-lg-8 offset-lg-2">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 text-right">
                        <a href="/post/approve/<?=$post->id; ?>/<?=\App\Helper\Formater::space2dash($post->title); ?>" class="btn btn-success">
                            <i class="fas fa-check-double"></i> Approve
                        </a>
                        <a href="/post/block/<?=$post->id; ?>/<?=\App\Helper\Formater::space2dash($post->title); ?>" class="btn btn-danger">
