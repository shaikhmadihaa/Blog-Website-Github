                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cover_img" class="form-control"
                                            ...
                                            value="<?php echo isset($data) ? htmlspecialchars($data->cover_img) : null; ?>">
                                        <?php if (isset($errors)): ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="subject" id="" class="form-control">
                                            ...
                                            foreach ($subjects as $subject) {
                                                $selected = (isset($data) && $data->subject == $subject) ? 'selected' : '';
                                                echo '<option value="' . $subject . '" ' . $selected . '>' . ucfirst($subject) . '</option>';
                                            }
                                            ?>
                                        </select>
